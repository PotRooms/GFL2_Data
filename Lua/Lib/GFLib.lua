...
enumUIPanel = CS.GF2.UI.enumUIPanel
...
NetCmdRecreationdeckData = CS.NetCmdRecreationdeckData.Instance
...
NetCmdControlFightData = CS.NetCmdControlFightData.Instance
...
BpTaskType = CS.GF2.Data.BpTaskType
...
SceneObjManager = CS.BattleContext.Instance.SceneObjectManager
...
OpenFunctionsManager = CS.GF2.Logic.OpenFunctionsManager.OpenFunctionsManager.Instance
...
NetCmdActivityBingoData = CS.NetCmdActivityBingoData.Instance
...
NetCmdActivityDarkZone = CS.NetCmdActivityDarkZone.Instance
DarkHelper = CS.DarkUnitWorld.DarkHelper
NetCmdActivitySimData = CS.NetCmdActivitySimData.Instance
NetCmdActivityReceiveStaminaData = CS.NetCmdActivityReceiveStaminaData.Instance
NetCmdActivityStoreData = CS.NetCmdActivityStoreData.Instance
NetCmdCafeTablet = CS.NetCmdCafeTablet.Instance
NetCmdActivityRegressData = CS.NetCmdActivityRegressData.Instance
ThemeActivityType = CS.ThemeActivityType
SubmoduleType = CS.GF2.Data.SubmoduleType
PlayerCounterSystem = CS.ProtoObject.PlayerCounterSystem
NetCmdCounterData = CS.NetCmdCounterData.Instance
ActivitySimState = CS.Activities.ActivitySim.ActivitySimDefine.ActivitySimState
NetCmdActivityTreasureData = CS.NetCmdActivityTreasureData.Instance
NetCmdActivityChrTryData = CS.NetCmdActivityChrTryData.Instance
UnityInstantiate = CS.UnityEngine.GameObject.Instantiate
NetCmdActivityChapterOpenData = CS.NetCmdActivityChapterOpenData.Instance
PoolEnum = CS.GF2.UI.PoolEnum
UIGray = CS.UIGray
NetCmdHigherPVPData = CS.NetCmdHigherPVPData.Instance
NetCmdActivityDropUpData = CS.NetCmdActivityDropUpData.Instance
ThemeEntranceStatus = CS.ThemeEntranceStatus
UIOperationActivityDefine = CS.UIOperationActivityDefine
UIActivityItemBase = CS.UIActivityItemBase
NetCmdActivityChrChallengeData = CS.NetCmdActivityChrChallengeData.Instance
NetCmdTeachPPTData = CS.NetCmdTeachPPTData.Instance
TipsPanelHelper = CS.GF2.Tips.TipsPanelHelper
NetCmdSocialData = CS.NetCmdSocialData.Instance
NetCmdGuildGroupData = CS.NetCmdGuildGroupData.Instance
NetCmdCareData = CS.NetCmdCareData.Instance
GunTypeStr = {
  "HG",
  "SMG",
  "RF",
...
function unityInstantiate(prefab, parent, instantiateInWorldSpace)
  return UnityInstantiate(prefab, parent, instantiateInWorldSpace or false)
end
...
function setactive(objtranscomp, active)
  return setactivewithcheck(objtranscomp, active)
end

function setactivecompontarray(components, active)
  LuaUtils.SetActiveWithCheck(components, active)
end

function setactivecompontlist(components, active)
  LuaUtils.SetActiveWithCheck(components, active)
end

function setinteractable(objtranscomp, active)
  if objtranscomp == nil then
    print("\232\174\190\231\189\174\228\186\134\231\169\186\231\154\132\229\175\185\232\177\161\239\188\129\239\188\129\239\188\129\239\188\129\239\188\129")
  end
  local canvasGroup = objtranscomp.gameObject:GetComponent(typeof(CS.UnityEngine.CanvasGroup))
  if canvasGroup ~= nil and canvasGroup.interactable ~= active then
