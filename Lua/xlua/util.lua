...
local print_func_ref_by_csharp = function()
  ...
  for k, v in pairs(registry) do
    if type(k) == "number" and type(v) == "function" and registry[v] == k then
      ...
      CS.UnityEngine.Debug.LogError(string.format("\229\188\149\231\148\168\230\156\170\233\135\138\230\148\190\239\188\129\n%s\239\188\140Lua\229\188\149\231\148\168\232\162\171C#\230\140\129\230\156\137", logPath))
    end
  end
end
local __g = _G
