...
function UIPVPStoreExchangePanel.OnGoodsItemClicked(gameObj)
  ...
  if eventTrigger ~= nil then
    ...
    elseif item.mData:IsSellout() then
      UITipsPanel.OpenStoreGoodByItemData(item.mData.name, icon, item.mData.description, item.mData.rank, TableData.GetItemData(item.mData.frame))
...
function UIPVPStoreExchangePanel:OpenConfirmPanel(itemData)
  gfdebug("\232\180\173\228\185\176\231\161\174\232\174\164\233\157\162\230\157\191")
  local paramData = CS.UIStoreConfirmPanel.Param(itemData, function()
    self:RefreshUnlockTip()
  end)
  UIManager.OpenUIByParam(UIDef.UIStoreConfirmPanel, paramData)
end

function UIPVPStoreExchangePanel:OpenUnlockPanel(storeData)
  gfdebug("\230\156\170\232\167\163\233\148\129\232\175\166\230\131\133\231\149\140\233\157\162")
  UIManager.OpenUIByParam(UIDef.UIStoreLockDialog, CS.UIStoreLockDialog.Param(storeData))
end
...
function UIPVPStoreExchangePanel.OnRefreshStoreGood(ret)
  ...
  if ret == ErrorCodeSuc then
    gfdebug("\229\136\183\230\150\176\229\149\134\229\147\129\229\136\151\232\161\168")
    self:InitStoreItems()
    ...
    gfdebug("\229\136\183\230\150\176\229\149\134\229\147\129\229\136\151\232\161\168\229\164\177\232\180\165")
    MessageBox.Show("\229\135\186\233\148\153\228\186\134", "\229\136\183\230\150\176\229\149\134\229\147\129\229\136\151\232\161\168\229\164\177\232\180\165!", MessageBox.ShowFlag.eMidBtn, nil, nil, nil)
  end
end
