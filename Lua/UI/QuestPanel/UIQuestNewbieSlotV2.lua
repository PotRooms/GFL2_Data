...
function UIQuestNewbieSlotV2:Refresh()
  local rewardShow = string.split(self.questData.rewardShow, ":")
  local itemID = 0
  local num = 0
  if itemID then
    itemID = tonumber(rewardShow[1])
    num = tonumber(string.split(rewardShow[2], ";")[1])
  ...
  self.ui.mText_IndexNum.text = num
