...
function RedPointSystem:UpdateRedPointByType(type, needMessage)
  ...
  elseif type == RedPointConst.TeachPPT then
    if NetCmdTeachPPTData:ShowRed_Type(CS.EPPTGroupType.All) or 0 < NetCmdTeachPPTData:GetAwardNum() then
      count = count + 1
    end
  ...
  elseif type == RedPointConst.MainGuild then
    count = NetCmdGuildGroupData:OnRedPoint_Guild(nil)
  elseif type == RedPointConst.Daily or type == RedPointConst.MainDaily then
    count = NetCmdQuestData:UpdateRedPoint() + NetCmdAchieveData:UpdateAchievementRedPoint()
  ...
  elseif type == RedPointConst.PlayerCard then
  ...
  elseif type == RedPointConst.RepositoryBox then
    count = NetCmdItemData:UpdateGiftPickRedPoint()
  ...
  elseif type == RedPointConst.Store or type == RedPointConst.MainStore then
  ...
  elseif type == RedPointConst.RecentActivity or type == RedPointConst.MainRecentActivity then
    ...
    if NetCmdThemeData:GetThemeRedState() == 1 then
      count = count + 1
    end
  ...
  elseif type == RedPointConst.Social then
    count = NetCmdSocialData:UpdateChatRedPoint()
  end
...
function RedPointSystem:UpdateAllSystem()
  ...
  self:UpdateRedPointByType(RedPointConst.TeachPPT)
