...
function UICommonLevelUpPanel.Open(type, data, showGet, showAllItems, onCloseCallBack)
...
function UICommonLevelUpPanel.Close()
  ...
  AccountNetCmdHandler:ResetPreLevel()
...
function UICommonLevelUpPanel:OnInit(root, data)
  ...
  self:CleanClickTime()
  self.clickTime = TimerSys:DelayCall(3, function()
...
function UICommonLevelUpPanel:CleanClickTime()
