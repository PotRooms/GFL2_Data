...
function ActivityTourDoubleCheckDialog:ManualUI()
  ...
  self.rewardUILits = {}
  self.ui.mText_Title.text = MonopolyUtil:GetMonopolyActivityHint(270090)
  self.ui.mText_Content.text = MonopolyUtil:GetMonopolyActivityHint(270218)
end
...
function ActivityTourDoubleCheckDialog:ItemRenderer(index, renderData)
  ...
  item:SetItemData(itemData.Id, itemData.Num, nil, nil, nil, nil, nil, function()
    TipsPanelHelper.OpenUITipsPanel(TableData.GetItemData(itemData.Id))
  end)
end
