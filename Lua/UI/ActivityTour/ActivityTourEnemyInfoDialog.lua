...
function ActivityTourEnemyInfoDialog:ManualUI()
  ...
  CSUIUtils.GetAndSetActivityHintText(self.mUIRoot, self.activityId, 2, 3002, self.monopolyId)
  self.enemyUIList = {}
  self.enemyHeadList = {}
  self.spineItemList = {}
end
...
function ActivityTourEnemyInfoDialog:RefreshRightInfo(index)
  ...
  self.ui.mText_Team.text = TableData.GetActivityHint(270299, self.activityId, 2, 3002, self.monopolyId)
