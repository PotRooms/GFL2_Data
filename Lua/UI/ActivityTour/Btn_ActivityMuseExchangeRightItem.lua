...
function Btn_ActivityMuseExchangeRightItem:SetData(data, themeId)
  ...
  if self.roleData then
    ...
    self.ui.mImg_Avatar.sprite = IconUtils.GetPlayerAvatar(TableData.GetPlayerAvatarIconById(self.roleData.Portrait, LuaUtils.EnumToInt(self.roleData.Sex)))
  ...
  self.offerItem:SetItemData(data.Offer, nil, nil, nil, nil, nil, nil, function()
    TipsPanelHelper.OpenUITipsPanel(TableData.GetItemData(data.Offer))
  end)
  ...
  self.needItem:SetItemData(data.Need, nil, nil, nil, nil, nil, nil, function()
    TipsPanelHelper.OpenUITipsPanel(TableData.GetItemData(data.Need))
  end)
end

function Btn_ActivityMuseExchangeRightItem:OnClickUserAvatar()
  LuaUtils.OpenUIPlayerInfoDialog(self.roleData)
end
