...
function UIChrScreenPanel:UpdatePanel()
  ...
  if gunData.TabGunData.second_duty ~= 0 then
    ...
    dutyTxt = dutyTxt .. "\194\183" .. secondDutyData.name.str
  end
  ...
  setactive(self.ui.mTrans_LevelUpConsume.gameObject, self.isGunLock)
  ...
  if self.isGunLock then
    ...
    UIUtils.GetButtonListener(self.ui.mBtn_ConsumeItem.gameObject).onClick = function()
      ...
      TipsPanelHelper.OpenUITipsPanel(data, 0, true)
    end
...
function UIChrScreenPanel:UnLockCallBack(ret)
  if ret == ErrorCodeSuc then
    printstack("\232\167\163\233\148\129\228\186\186\229\189\162\230\136\144\229\138\159")
