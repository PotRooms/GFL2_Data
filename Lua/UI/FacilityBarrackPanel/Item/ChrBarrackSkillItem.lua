...
function ChrBarrackSkillItem:SetData(gunCmdData, skillId, callback)
...
function ChrBarrackSkillItem:UpdateWeak()
  local parentTrans = self.ui.mTrans_WeaponElement
  local weaponStcId = self.gunCmdData.WeaponStcId
  local weak = CS.WeakUIUtils.SetSkillWeakWeapon(weaponStcId, self.mBattleSkillData.id, parentTrans, false, 0)
