...
function GrpAttributeBaseItemV3:SetGunValueFrom()
  self.ui.mText_BaseTitle.text = self.mLanguagePropertyData.barrack_show_description.str
  self.valueFrom = {}
  self.tmpValue = 0
  self:GetGunValue()
  self:GetWeaponValue()
  ...
  self:GetGunLoveValue()
  self:GetGunLoveVowValue()
  self:GetGunControlRoomValue()
...
function GrpAttributeBaseItemV3:GetGunLoveValue()
  local baseItem = ChrAttributeBaseInfoItemV3.New()
  baseItem:InitCtrl(self.listParent, self:GetTmpObj(6))
  local value = 0
  if self.curAttributeShowType == FacilityBarrackGlobal.AttributeShowType.Gun then
    value = self.gunData:GetGunLovePropertyDecimalValueWithPercent(self.sysName)
  end
  baseItem:SetProp(self.mLanguagePropertyData, value, 300057)
  table.insert(self.valueFrom, baseItem)
  self.tmpValue = self.tmpValue + value
end

function GrpAttributeBaseItemV3:GetGunLoveVowValue()
  local baseItem = ChrAttributeBaseInfoItemV3.New()
  baseItem:InitCtrl(self.listParent, self:GetTmpObj(7))
  local value = 0
  if self.curAttributeShowType == FacilityBarrackGlobal.AttributeShowType.Gun then
    value = self.gunData:GetGunLoveVowPropertyDecimalValueWithPercent(self.sysName)
  end
  baseItem:SetProp(self.mLanguagePropertyData, value, 300058)
  table.insert(self.valueFrom, baseItem)
  self.tmpValue = self.tmpValue + value
end

function GrpAttributeBaseItemV3:GetGunControlRoomValue()
  local baseItem = ChrAttributeBaseInfoItemV3.New()
  baseItem:InitCtrl(self.listParent, self:GetTmpObj(8))
  local value = 0
  if self.curAttributeShowType == FacilityBarrackGlobal.AttributeShowType.Gun then
    value = self.gunData:GetGunControlRoomPropertyDecimalValueWithPercent(self.sysName)
  end
  baseItem:SetProp(self.mLanguagePropertyData, value, 400182)
  table.insert(self.valueFrom, baseItem)
  self.tmpValue = self.tmpValue + value
end
