...
function ChrWeaponItem:SetData(gunCmdData, callback, isDefault, needRedPoint)
  ...
  setactive(self.ui.mImg_WeaponIcon.gameObject, false)
  IconUtils.GetWeaponNormalSpriteAsync(self.ui.mImg_WeaponIcon, self.weaponCmdData.StcData.res_code, function(s, o, arg3)
    setactive(self.ui.mImg_WeaponIcon.gameObject, true)
  end)
