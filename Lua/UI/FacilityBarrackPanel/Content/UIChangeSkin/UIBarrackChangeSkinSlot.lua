...
function UIBarrackChangeSkinSlot:Refresh()
  ...
  local isFocusEquipped = self.clothesId == self.gunCmdData.OriginCostume
...
function UIBarrackChangeSkinSlot:SetInteractable(interactable)
  self.ui.mBtn_ChrSkinChangeItem.interactable = interactable
end

function UIBarrackChangeSkinSlot:SetSelect(isSelect)
  self.ui.mAnimator:SetBool("Selected", isSelect)
end
