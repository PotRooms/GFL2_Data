...
function UIBarrackLevelUpFinishDialog:refreshAllProperty()
  ...
  for i = startPropertyId + 1, endPropertyId - 1 do
    ...
    if propertyType then
      local prevValue = PropertyUtils.GetBasePropertyValue(self.gunId, self.gunCmdData.OldLevel, propertyType) + self.gunCmdData:GetCurGunClassValueByPropertyType(propertyType)
...
function UIBarrackLevelUpFinishDialog:PlayShowPanelAudio()
end
