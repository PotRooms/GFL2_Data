...
function UIRepositoryWeaponPartsPanel:Show()
  ...
  self:onClickSuitTab(1, true)
  self:onClickPartsPosTab(1, true)
...
function UIRepositoryWeaponPartsPanel:ItemRenderer(index, renderData)
  ...
  item:SetWeaponPartsData(data, UIRepositoryWeaponPartsPanel.OnClickWeaponPartsItem, nil, nil, param)
end
...
function UIRepositoryWeaponPartsPanel:onClickSuitTab(suitTabIndex, keep)
...
function UIRepositoryWeaponPartsPanel:onClickPartsPosTab(partsPosTabIndex, keep)
