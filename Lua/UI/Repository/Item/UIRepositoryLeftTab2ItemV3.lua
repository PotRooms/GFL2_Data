...
function UIRepositoryLeftTab2ItemV3:InitCtrl(parent, isWhite)
  local tabName = "UICommonFramework/ComTabBtn1ItemV2_B.prefab"
  if isWhite ~= nil and isWhite == true then
    tabName = "UICommonFramework/ComLeftTab1ItemV2_W.prefab"
  end
  local prefab = UIUtils.GetGizmosPrefab(tabName, self)
