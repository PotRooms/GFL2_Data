...
function UICommonGrpItem:SetWeaponPartsData(data, callback, isFocus, isSelect, listParam)
  self.ui.mCanvasGroup_Item.alpha = 0
  self.ui.mCanvasGroup_Weapon.alpha = 1
  self.ui.mCanvasGroup_WeaponParts.alpha = 0
  self:SetItemCanBeClick()
  ...
  self.weaponItem:SetWeaponPartsData(data, callback, isFocus, isSelect, listParam)
