...
function UIComTabBtn1Item:InitCtrl(root, isBlack)
  local tabName = "UICommonFramework/ComTabBtn1ItemV2.prefab"
  if isBlack ~= nil and isBlack == true then
    tabName = "UICommonFramework/ComTabBtn1ItemV2_B.prefab"
  end
