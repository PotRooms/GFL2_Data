...
function UIUtils.GetUIRes(path)
  ...
  if sourcePrefab == nil then
    print("\230\178\161\230\156\137\232\181\132\230\186\144 \239\188\154" .. path)
  end
  return sourcePrefab
end
...
function UIUtils.InstantiateByTemplate(template, parent)
  ...
  return unityInstantiate(template, parent, false)
end

function UIUtils.GetUIBindTable(component)
  local res = {}
  LuaBindingNew.BindLuaUIBindTable(res, component)
  return res
end
...
function UIUtils.GetDarkPanelTool(path, owner)
  ...
  if prefab == nil then
    print("\230\178\161\230\156\137\230\154\151\229\140\186\232\175\166\230\131\133\233\157\162\230\157\191")
  end
  if owner ~= nil then
...
function UIUtils.GetDarkPanelBoxItem(path, owner)
  local boxitem = ResSys:GetDzUIItem("DarkzoneBoxItem")
  if boxitem == nil then
    print("\230\178\161\230\156\137\230\154\151\229\140\186boxitem")
  end
  if owner ~= nil then
...
function UIUtils.GetDzUIItem(path, owner)
  local getitem = ResSys:GetDzUIItem(path)
  if getitem == nil then
    print("\230\178\161\230\156\137\230\154\151\229\140\186GetDzUIItem")
  end
  if owner ~= nil then
...
function UIUtils.GetDarkZoneTeamUIModelAsyn(gunId, weaponId, index, callback, questID)
  if questID == nil then
    questID = 0
  end
  CS.UIDarkZoneTeamModelManager.Instance:GetDarkZoneTeamModel(gunId, weaponId, index, true, callback, true, questID)
end
...
function UIUtils.GetWidget(root, path, widgetType)
  ...
  if type(widgetType) ~= "userdata" then
    print_error("\229\143\170\232\131\189\228\189\191\231\148\168typeof\232\142\183\229\143\150\231\187\132\228\187\182")
    return
  end
  local tObj
...
function UIUtils.CheckIsUnLock(jumpID, callback)
  ...
  elseif jumpType == 1014 then
    local chapterID = tonumber(jumpParam[1])
    if chapterID then
      local tbData = TableData.listDifficultyChapterDatas:GetDataById(chapterID)
      if tbData then
        for i = 0, tbData.unlock.Count - 1 do
          if not NetCmdAchieveData:CheckComplete(tbData.unlock[i]) then
            return -2
          end
        end
      end
...
function UIUtils.Destory(unityObj)
  CS.LuaUtils.Destroy(unityObj)
end
...
function UIUtils.ChangeNumDigit(num)
  if type(num) ~= "number" then
    gfdebug("\231\177\187\229\158\139\228\188\160\232\190\147\233\148\153\232\175\175\239\188\140\232\191\148\229\155\158\233\187\152\232\174\164\229\128\188\239\188\140\232\175\183\230\163\128\230\159\165\233\129\147\229\133\183" .. self.itemID)
    return 0
  end
  local hint
...
function UIUtils.ChangeNumByDigit(num, digit)
  if type(num) ~= "number" then
    gfdebug("\231\177\187\229\158\139\228\188\160\232\190\147\233\148\153\232\175\175\239\188\140\232\191\148\229\155\158\233\187\152\232\174\164\229\128\188\239\188\140\232\175\183\230\163\128\230\159\165")
    return 0
  end
...
function UIUtils.GetIfNotEnoughTextWithDigit(itemId, cost, digit)
  ...
  local haveCount = NetCmdItemData:GetNetItemCount(itemId)
  local haveDigit = CS.LuaUIUtils.GetMaxNumberText(haveCount, digit)
...
function UIUtils.Clam(value, min, max)
  if max < value then
    value = max
  end
  if min > value then
...
function UIUtils.GetGameObjectFromPool(enum, parent)
  local go = ResSys:GetGameObjectFromPool(enum)
  if go and parent then
    CS.LuaUIUtils.SetParent(go, parent, true)
  end
  return go
end

function UIUtils.ReturnToPool(go)
  ResSys:ReturnToPool(go)
end
