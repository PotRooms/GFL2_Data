...
function UISimCombatResourceTabList:getTabIndexBySimTypeId(simTypeId)
  ...
  gferror("\229\189\147\229\137\141\230\178\161\230\156\137\230\137\190\229\136\176Target tab index!")
  return 1
end
...
function UISimCombatResourceTabList:onTabChanged(prevTabIndex, currTabIndex)
  ...
  if not curTab then
    gferror("\229\189\147\229\137\141\230\178\161\230\156\137\233\128\137\228\184\173\231\154\132Tab!")
    return
  end
