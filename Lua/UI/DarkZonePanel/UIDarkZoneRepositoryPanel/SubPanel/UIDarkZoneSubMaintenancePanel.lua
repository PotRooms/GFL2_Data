...
function UIDarkZoneSubMaintenancePanel:Show(scrollToTop)
  ...
  self.ui.mText_Bag.text = TableData.GetHintById(903130) .. "\227\128\144" .. DarkZoneNetRepoCmdData:GetBagItemCount(self.curFilterIndex) .. "/" .. DarkZoneNetRepoCmdData:GetBagValidCount(self.curFilterIndex) .. "\227\128\145"
  self.ui.mText_Repo.text = TableData.GetHintById(903131) .. "\227\128\144" .. DarkZoneNetRepoCmdData:GetRepoItemCount(self.curFilterIndex) .. "/" .. DarkZoneNetRepoCmdData:GetRepoValidCount(self.curFilterIndex) .. "\227\128\145"
end
...
function UIDarkZoneSubMaintenancePanel:ResetBriefBottomFunc(parent, type, data)
  local ShowItemDetail = function()
    TipsPanelHelper.OpenUITipsPanel(data.ItemData, 0, true)
  end
