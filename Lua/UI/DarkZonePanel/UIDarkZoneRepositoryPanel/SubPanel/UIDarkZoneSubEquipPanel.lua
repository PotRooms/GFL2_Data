...
function UIDarkZoneSubEquipPanel:SetEquipDict(isInit)
  ...
  self.equippedDict = DarkZoneNetRepoCmdData.EquippedDict
  self.ui.mText_RepoTitle.text = TableData.GetHintById(903131) .. "\227\128\144" .. DarkZoneNetRepoCmdData:GetRepoItemCount(1) .. "/" .. DarkZoneNetRepoCmdData:GetRepoValidCount(1) .. "\227\128\145"
