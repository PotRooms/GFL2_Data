...
function CommanderBgItem:SetData(data, panel)
  ...
  setactive(self.ui.mImg_Pic, false)
  IconUtils.GetAtlasSpriteAsyc("CommandCenterBgPic/" .. data.pic, function(s, o, arg)
    if o then
      self.ui.mImg_Pic.sprite = o
    else
      self.ui.mImg_Pic.sprite = IconUtils.GetAdjutantRoomPic(data.pic)
    end
    setactive(self.ui.mImg_Pic, true)
  end)
