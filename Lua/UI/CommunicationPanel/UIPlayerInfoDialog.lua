...
UIPlayerInfoDialog.playerInfoItem = nil88
...
function UIPlayerInfoDialog:OnInit(root, data)
  ...
  self:UpdatePanel()
  self:SetFirendInfoState(false)
  self.playerInfoItem:UpdateBtnState(false)
end
...
function UIPlayerInfoDialog:SetFirendInfoState(isActive)
  setactive(self.ui.mTrans_Actions, isActive)
end
