...
function UICommonBirthModifyPanel.OpenBirthDayPanelByCSharp(data)
  if data == nil or data.Length ~= 3 then
    return
  end
  UICommonBirthModifyPanel.OpenBirthDayPanel(data[0], data[1], data[2])
end
