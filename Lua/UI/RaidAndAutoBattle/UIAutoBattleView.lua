...
function UIAutoBattleView.UpdateTimesNum()
  ...
  self.mText_BasePanel_battleResult.text = string.format("\232\131\156\229\136\169\230\172\161\230\149\176:%d  \229\164\177\232\180\165\230\172\161\230\149\176:%d", AFKBattleManager.WinTimes, AFKBattleManager.FailedTimes)
end
