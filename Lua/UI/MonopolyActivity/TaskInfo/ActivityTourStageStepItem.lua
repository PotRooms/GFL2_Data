...
function ActivityTourStageStepItem:SetData(taskId, isPlayFadeIn)
  ...
  if self.mData == nil then
    print_error("MonopolyWinCondition\232\161\168\228\184\173\230\178\161\230\156\137\230\137\190\229\136\176ID\239\188\154" .. tostring(taskId) .. "\231\154\132\230\149\176\230\141\174")
    return
  end
...
function ActivityTourStageStepItem:Refresh(isPlayFadeIn)
  ...
  local newUnComplete = not isPlayFadeIn and oldIsComplete and not self.isComplete
  ...
  if newUnComplete then
    self:PlayAnimator(AnimType.CompleteToNormal)
  end
end
...
function ActivityTourStageStepItem:RefreshContent()
  ...
  self.ui.mText_Desc.text = UIUtils.StringFormat(MonopolyUtil:GetMonopolyActivityHint(270155), self.mData.name.str, self.mCurNum, self.mMaxNum)
end
