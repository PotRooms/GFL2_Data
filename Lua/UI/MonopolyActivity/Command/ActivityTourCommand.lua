...
function ActivityTourCommand:DeleteCommand(data, slotIndex)
  if MonopolyWorld.MpData.commandList.Count == 1 then
    CS.PopupMessageManager.PopupString(MonopolyUtil:GetMonopolyActivityHint(270220))
    return
  end
  local content = UIUtils.StringFormat(MonopolyUtil:GetMonopolyActivityHint(270167), data.sold)
  MessageBox.Show(TableData.GetHintById(208), content, nil, function()
    ...
    MonopolyWorld.MpData:DeleteCommand(slotIndex, function(ret)
...
function ActivityTourCommand:RefreshCommand(slotIndex)
  ...
  if slotIndex < 0 then
    print_error("\229\188\130\229\184\184\239\188\140\230\178\161\230\156\137\230\140\135\228\187\164\229\143\175\231\148\168\228\184\186\231\169\186")
    return
  end
...
function ActivityTourCommand:OnClickCommand(index)
  if MonopolyWorld:CanUseOrder() == false then
    return
  end
