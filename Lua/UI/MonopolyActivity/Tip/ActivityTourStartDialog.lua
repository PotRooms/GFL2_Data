...
function ActivityTourStartDialog:UpdateAll(isNewStart)
  ...
  if isNewStart then
    self.ui.mText_Title.text = MonopolyUtil:GetMonopolyActivityHint(270156)
    self.ui.mText_Desc.text = MonopolyUtil:GetMonopolyActivityHint(270157)
  else
    self.ui.mText_Title.text = MonopolyUtil:GetMonopolyActivityHint(270158)
    self.ui.mText_Desc.text = MonopolyUtil:GetMonopolyActivityHint(270159)
  end
