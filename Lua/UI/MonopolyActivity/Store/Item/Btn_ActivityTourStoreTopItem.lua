...
function Btn_ActivityTourStoreTopItem:SetData(tabType, clickCallBack)
  ...
  self.ui.mText_Name.text = self.tabType == ActivityTourGlobal.StoreTabType_Buy and MonopolyUtil:GetMonopolyActivityHint(270250) or MonopolyUtil:GetMonopolyActivityHint(270251)
end
