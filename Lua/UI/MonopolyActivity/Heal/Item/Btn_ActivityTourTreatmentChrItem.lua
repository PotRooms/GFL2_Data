...
function Btn_ActivityTourTreatmentChrItem:SetData(index, uiType, selCallBack, gunInfo, healNum, isGray)
  self.uiType = uiType
  ...
  UIGray.SetGray(self.ui.mTrans_Char, isGray)
  self.ui.mText_Steady.text = MonopolyUtil:GetMonopolyActivityHint(270239)
  self:ShowWillValue(self.gunInfo.Ip.WillValue, self.gunInfo.Id)
  self.ui.mText_Hp.text = MonopolyUtil:GetMonopolyActivityHint(270240)
