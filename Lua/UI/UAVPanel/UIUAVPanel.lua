...
function UIUAVPanel:UpdateRightAreaInfo(IsShowSkillInfo)
  ...
  if attackDataRow then
    ...
    gferror("LanguageElement\232\161\168\230\178\161\230\156\137\230\137\190Id: " .. attackTypeId)
  end
  ...
  if shieldDataRow then
    ...
    gferror("LanguageShield\232\161\168\230\178\161\230\156\137\230\137\190Id: " .. shieldTypeId)
  end
  self.mView.mText_OilCost.text = TableData.GetHintById(105011)
