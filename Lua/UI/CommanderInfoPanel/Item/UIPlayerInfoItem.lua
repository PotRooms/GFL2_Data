  ...
  if self.robotInfo == nil and self.playerInfo.UID ~= nil and self.playerInfo.UID ~= 0 then
    ...
    if self.robotInfo then
      ...
      if gun then
        ...
        gferror("\228\186\186\229\189\162\230\156\186\229\153\168\228\186\186\232\142\183\229\143\150\229\188\130\229\184\184")
      end
...
function UIPlayerInfoItem:UpdateBtnState(state)
  self.ui.mBtn_Signature.interactable = state
...
function UIPlayerInfoItem:UpdateAchievements()
  ...
  for i = CS.LuaUtils.EnumToInt(CS.ProtoObject.AchieveRank.Gold), CS.LuaUtils.EnumToInt(CS.ProtoObject.AchieveRank.Plastics) do
