...
function UIGuideWindows:InitWithTutorialGroupId(tutorialGroupId)
  ...
  if self.pageDataList == nil or self.pageDataList.Count == 0 then
    gferror(" guidePages \230\137\190\228\184\141\229\136\176  tutorialGroupId  " .. tutorialGroupId)
    self:Close()
    return
  end
...
function UIGuideWindows:UpdatePage(index, data)
  ...
  elseif data.type == 2 then
    ...
    gferror("\228\184\186\229\174\154\228\185\137\231\154\132\231\177\187\229\158\139!   " .. tostring(data.type))
  end
end
