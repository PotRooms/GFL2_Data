...
function UIAchievementPanelV2:ReleaseTimer()
  if self.achieveTimer then
    self.achieveTimer:Stop()
    self.achieveTimer = nil
  end
end
...
function UIAchievementPanelV2:OnReceivedCallback(ret)
  ...
  if ret == ErrorCodeSuc then
    ...
    self.achieveTimer = TimerSys:DelayCall(0.4, function()
