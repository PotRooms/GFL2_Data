...
function UIBpMissionPanel:InitCtrl(prefab, parent, parentCls)
  self:__InitCtrl()
...
function UIBpMissionPanel:IsObjNull()
...
function UIBpMissionPanel:InitBase(prefab, parent)
  ...
  function self.ui.mVirtualListEx.itemCreated(renderData)
...
function UIBpMissionPanel:itemProvider(renderData)
  local slot = BpMissionListItem.New(renderData, self)
