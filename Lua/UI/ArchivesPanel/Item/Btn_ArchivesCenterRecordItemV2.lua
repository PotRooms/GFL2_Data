...
function Btn_ArchivesCenterRecordItemV2:InitCtrlWithNoInstantiate(obj)
...
function Btn_ArchivesCenterRecordItemV2:OnBtnClick(data)
  ...
  local action = function()
    ...
    elseif informationData.type == 2 then
      ...
      gferror("Oss \229\173\152\229\156\168\230\156\170\229\174\154\228\185\137\231\154\132\231\177\187\229\158\139")
    end
  end
