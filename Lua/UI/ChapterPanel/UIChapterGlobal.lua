...
function UIChapterGlobal:RecordChapterId(chapterId)
  ...
  gfdebug("UIChapterGlobal.RecordChapterId: " .. tostring(chapterId))
  if chapterId ~= nil then
    NetCmdDungeonData:RecordDifficultyIdByChapterId(chapterId)
  end
end

function UIChapterGlobal:GetRecordOrCurrStoryChapterId()
  return UIChapterGlobal:GetRecordChapterId() or NetCmdDungeonData:GetMaxClearedChapterIdWithIgnoreDifficulty()
end
