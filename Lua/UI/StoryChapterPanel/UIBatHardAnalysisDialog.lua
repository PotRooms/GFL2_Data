...
function UIBatHardAnalysisDialog:ShowTipList()
  ...
  if self.curIndex <= #self.tipsList then
    ...
    elseif self.isChapterLastStory then
      str = "\228\184\139\228\184\128\231\171\160\232\138\130\229\183\178\232\167\163\233\148\129\239\188\136\231\168\139\229\186\143\230\137\128\229\134\153\239\188\137"
    else
