...
GlobalConfig.ItemType = {
  ...
  WeaponCod = CS.GF2.Data.ItemType.WeaponCod:GetHashCode(),
  WeaponCod1 = CS.GF2.Data.ItemType.WeaponCod1:GetHashCode(),
  WeaponSkin = CS.GF2.Data.ItemType.WeaponSkin:GetHashCode(),
  WeaponModSkin = CS.GF2.Data.ItemType.WeaponModSkin:GetHashCode()
}
...
GlobalConfig.DoNotNeedNumType = {
  [GlobalConfig.ItemType.Title] = 1,
  [GlobalConfig.ItemType.Medal] = 1,
  [GlobalConfig.ItemType.PlayerAvatarFrame] = 1,
  [GlobalConfig.ItemType.PlayerAvatar] = 1
}
