...
function ChrWeaponLvUpAttributeDetailItemV4:ShowDiff(data, prevValue, curValue, needTween, forceSetValue)
  ...
  self.ui.mText_AttrNumBefore.color = UIWeaponGlobal.WeaponBreakColor.WhiteColor
  if curValue >= self.defaultMaxValue then
    self.ui.mText_AttrNumNow.color = UIWeaponGlobal.WeaponBreakColor.YellowColor
  else
    self.ui.mText_AttrNumNow.color = UIWeaponGlobal.WeaponBreakColor.OrangeColor
  end
