...
ResourcesCommonItem.digitNum = 8
...
function ResourcesCommonItem:UpdateDarkIcon(num)
  ...
  self.ui.mText_Num.text = CS.LuaUIUtils.GetMaxNumberText(num, ResourcesCommonItem.digitNum)
...
function ResourcesCommonItem:UpdateData(paramData)
  ...
  if self.itemID == 9 then
    self.ui.mText_Num.text = CS.LuaUIUtils.GetMaxNumberText(count, ResourcesCommonItem.digitNum) .. "/" .. CS.LuaUIUtils.GetMaxNumberText(TableData.GlobalConfigData.SimtrainingTimes, ResourcesCommonItem.digitNum)
  elseif itemData.type == GlobalConfig.ItemType.StaminaType then
    self.ui.mText_Num.text = CS.LuaUIUtils.GetMaxNumberText(count, ResourcesCommonItem.digitNum) .. "/" .. CS.LuaUIUtils.GetMaxNumberText(GlobalData.GetStaminaResourceMaxNum(self.itemID), ResourcesCommonItem.digitNum)
  ...
  elseif self.itemID == NetCmdSimulateBattleData:GetWeeklyBCostItemId() then
    ...
    self.ui.mText_Num.text = CS.LuaUIUtils.GetMaxNumberText(count, ResourcesCommonItem.digitNum) .. "/" .. CS.LuaUIUtils.GetMaxNumberText(maxCount, ResourcesCommonItem.digitNum)
  else
    self.ui.mText_Num.text = CS.LuaUIUtils.GetMaxNumberText(tonumber(count), ResourcesCommonItem.digitNum)
  end
...
function ResourcesCommonItem:OnAddResBtnClicked()
  if self.itemID == GlobalConfig.StaminaId then
    ...
    UISystem:JumpByID(self.switchID)
  end
end
